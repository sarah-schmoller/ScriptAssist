...
def main():
    ...
    while True:
        try:
            ...
            text = generate_text(encoder, hparams, session, tf_sample, saver, context, batch_size)
...
def generate_text(encoder, hparams, session, tf_sample, saver, context, batch_size):
    ...
    context_str = str(open("contexts/shakespeare.txt", "r").read())
